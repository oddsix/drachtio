...
app.defaultConfiguration = function(){
  ...
  this.siprequest = uac.bind(undefined, this) ;
  methods.forEach(function(method){ 
    self.siprequest[method] = uac[method].bind(undefined, self) ;
  }) ;
  ...
  this.__defineGetter__('idle', function() {
    ...
    debug('rids: %d, uacTxns: %d, uasTxns: %d', rids, uacTxns, uasTxns) ;
...
app.connect = function(){
  var self = this ;
  this.agent = sip.createAgent(this);  
  ...
  this.agent.on('disconnect', function() { 
